...
namespace AmazonsGame
{
	...
	class AmazonFo
	{
		static void Main(string[] args)
		{
			...
			//Tábla étékei: 0 - üres - 'o', 1/2 - fehér/fekete bábú - 'w/b', 3 - nyíl - 'x', szóköszözökkel vannak elválasztva a mezők egy soron belül.

			Console.WriteLine("Adja meg a tábla állapotát:\nKérem soronként adja meg, a mezőket szóközökkel elválasztva.\nMezők: Üres - 'o', Fehér/fekete bábú - 'w'/'b', Nyíl - 'x'");
